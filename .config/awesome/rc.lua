...
local cw = calendar_widget({theme = "nord",
			    placement = "top_right",
...
globalkeys = gears.table.join(
    ...
    awful.key({ modkey,           }, "j",
        ...
        {description = "focus next by index", group = "felix"}
    ),
    awful.key({ modkey,           }, "k",
        function ()
            awful.client.focus.byidx(-1)
        end,
        {description = "focus previous by index", group = "felix"}
    ),
    ...
    awful.key({ modkey, "Control" }, "r", awesome.restart,
              {description = "reload awesome", group = "felix"}),
    awful.key({ modkey, "Shift"   }, "q", awesome.quit,
              {description = "quit awesome", group = "awesome"}),

    awful.key({ modkey,           }, "l",     function () awful.tag.incmwfact( 0.05)          end,
              {description = "increase master width factor", group = "felix"}),
    awful.key({ modkey,           }, "h",     function () awful.tag.incmwfact(-0.05)          end,
              {description = "decrease master width factor", group = "felix"}),
    ...
    awful.util.spawn("dmenu_run -nb '#282828' -nf '#e78a4e' -sf '#d4be98'") end,
              {description = "launch dmenu", group = "felix"}),
