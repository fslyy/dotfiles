...
awful.screen.connect_for_each_screen(function(s)
	...
	-- Create the wibox
	--    s.mywibox = awful.wibar({ position = "top", screen = s, opacity = 0.6, height = 30,})
...
globalkeys = gears.table.join(
	...
	awful.key({ modkey }, "j", function()
		awful.client.focus.byidx(1)
	end, { description = "focus next by index", group = "felix" }),
	awful.key({ modkey }, "k", function()
		awful.client.focus.byidx(-1)
	end, { description = "focus previous by index", group = "felix" }),
	...
	awful.key({ modkey, "Control" }, "r", awesome.restart, { description = "reload awesome", group = "felix" }),
	awful.key({ modkey, "Shift" }, "q", awesome.quit, { description = "quit awesome", group = "awesome" }),

	awful.key({ modkey }, "l", function()
		awful.tag.incmwfact(0.05)
	end, { description = "increase master width factor", group = "felix" }),
	awful.key({ modkey }, "h", function()
		awful.tag.incmwfact(-0.05)
	end, { description = "decrease master width factor", group = "felix" }),
	...
	awful.key({ modkey }, "space", function()
		awful.util.spawn("dmenu_run -nb '#282828' -nf '#e78a4e' -sf '#d4be98'")
	...
	awful.key({}, "#122", function()
		awful.util.spawn("amixer -q sset Master 10%-")
	end),
...
clientkeys = gears.table.join(
	...
	awful.key({ modkey }, "q", function(c)
		c:kill()
	end, { description = "close", group = "felix" }),
	awful.key(
		{ modkey, "Control" },
		"space",
		awful.client.floating.toggle,
		{ description = "toggle floating", group = "felix" }
	),
...
awful.spawn.with_shell("xss-lock -s ${XDG_SESSION_ID} -- i3lock -n -e -i Pictures/Bluescreen_locker.png & xset s 420") -- i3lock could be replaced by lock script (example: blur desktop)
