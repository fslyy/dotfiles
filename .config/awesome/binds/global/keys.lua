...
awful.keyboard.append_global_keybindings({
	...
	awful.key({ modkey }, "0", function()
		awful.spawn("/home/felix/.scripts/change_to_rndm_wallpaper.sh")
	end, { description = "change random wallpaper and theme", group = "felix" }),
	awful.key({ modkey }, "v", function()
		awful.spawn("/home/felix/.scripts/colorscheme_change_menu.sh | rofi -dmenu")
	end, { description = "open theme menu", group = "felix" }),
	...
	end, { description = "increase volume", group = "felix" }),
	awful.key({}, "#121", function()
		awful.spawn("amixer -q sset Master toggle")
	end, { description = "toggle volume", group = "felix" }),
	awful.key({}, "#232", function()
		awful.spawn("brightnessctl set 10-%")
	end, { description = "decrease brightness", group = "felix" }),
	awful.key({}, "#233", function()
		awful.spawn("brightnessctl set +10%")
	end, { description = "increase brigtness", group = "felix" }),
	awful.key({}, "Print", function()
		awful.spawn("flameshot gui")
	end, { description = "take screenshot", group = "felix" }),
	awful.key({ modkey }, "ß", function()
		awful.spawn("xset s activate")
	end, { description = "lock screen", group = "felix" }), -- triggers xset lock -> xss-lock -> i3lock (with co  mmand in spawn command down)
